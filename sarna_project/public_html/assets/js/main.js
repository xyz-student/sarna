...
function checkPosition()
{
    if($(window).width() < 767)
    {
        $(".our-clients marquee").contents().unwrap();
    } 
    // else {
...
$(window).scroll(function() {
    if($(window).scrollTop() > 50) {
        ...
        $('.header_middel').addClass('menu_fixed animated fadeInDown');
        
        // $('.header_middel').css('position','fixed');
        // $('.header_middel').css('background','#fff');
        // $('.header_middel').css('width','100%');
        // $('.header_middel').css('z-index','99');
        // $('.header_middel').css('top','0');
        // $('.main_menu').css('marginTop','10px');
        // $('.main_menu > ul > li > a').css('padding','0 10px');
        // $('.header_middel .logo img').css('width','120px');
    }
    else {
        $('.header_middel').removeClass('menu_fixed animated fadeInDown');
        // $('.header_middel').css('position','static');
        // $('.header_middel').css('background','rgb(226, 232, 241)');
        // $('.header_middel').css('width','100%');
        // $('.main_menu').css('marginTop','0px');
        // $('.main_menu > ul > li > a').css('padding','0 17px');
        // $('.header_middel .logo img').css('width','190px');
    }
})
...
var menuItem = document.querySelectorAll('#menubar a');
...
for(var i=0;i<menuLength;i++) {
    if(menuItem[i].href ===currentLocation) {
        ...
        // alert(menuItem[i].className);
    }
    // else if(menuItem[0]=="http://localhost/justrack/index.php") {
    //     alert('working');
...
$('#downloads a').addClass('badge badge-primary');