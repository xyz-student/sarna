...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
			...
			<div class="card">
				   <div class="card-body">
				   <div class="card-title">Update top Category</div>
				   <hr>
...
move_uploaded_file($image_tmp,$logo_path);
  ...
  $sql="UPDATE `top_category` SET `title`='$title',`image`='$final_img' WHERE id='$get_id'";
  ...
  if($query)
  {
	  ...
	  echo "<script>alert('update succesfully');window.location='top_category.php';</script>";
  }
}
else if($image_name == "") {
	$sql="UPDATE `top_category` SET `title`='$title',`image`='$old_image' WHERE id='$get_id'";
