...
$sql="INSERT INTO `product3`(`title3`, `img3`, `des3`, `cat_id3`) VALUES ('$title','$final_img1','$desc','$cat_name')";
	$query=mysqli_query($conn,$sql) or die(mysqli_error($conn));
// echo $query;
// exit();
	if($query)
	{
		 echo("<script>alert('Insert succesfully');window.location='product_table3.php';</script>");
	}
	else
	{
		echo("<script>alert('Insert Failed');window.location='insert_product3.php';</script>");
	}
	}
}
