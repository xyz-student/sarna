...
$sql="INSERT INTO `products`(`title`,`img1`,`des`,`cat_id`) VALUES ('$title','$final_img1','$desc','$cat_name')";
	$query=mysqli_query($conn,$sql) or die(mysqli_error($conn));
// echo $query;
// exit();
	if($query)
	{
		 echo("<script>alert('Insert succesfully');window.location='product_table.php';</script>");
	}
	else
	{
		echo("<script>alert('Insert Failed');window.location='insert_products.php';</script>");
	}
	}
}
