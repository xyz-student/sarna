			...
			<div class="card">
				...
				<form method="POST" enctype="multipart/form-data">
				   ...
				   <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="summernoteEditor" name="description"></textarea>
                                </div>
                            </div>
...
$sql="INSERT INTO `sub_category`(`sub_category_name`, `image`, `category_id`,`description`) VALUES ('$title','$final_img1','$cat_name','$desc')";
...
// exit();
	if($query)
	{
		 echo("<script>alert('Insert succesfully');window.location='sub_category.php';</script>");
	}
	else
	{
		echo("<script>alert('Insert Failed');window.location='sub_category_insert.php';</script>");
	}
	}
}
