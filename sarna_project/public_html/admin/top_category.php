...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header"><i class="fa fa-table"></i> top Category Table</div>
                    <div class="card-body">
                         <!-- pagination start ******************************   -->
             <?php 
    
    $q="SELECT * FROM `top_category`";
        ...
        ?>
                ...
                <!-- pagination end ******************* -->
                        <div class="table-responsive">
                            <a href="insert_top_category.php" class="btn btn-success" style="float:right;">Insert top
                                Category</a>
                            <table id="" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <?php 
    $query = "SELECT * FROM `top_category` order by id DESC LIMIT $result, $post_per_page";
...
?>
                                    <tr>
                                        ...
                                        <?php echo'
                        <td><a href="top_category_edit.php?cat_id='.$id.'"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
            <a href="delete_top_category.php?cat_id='.$id.'"><i class="fa fa-trash-o"></a></td>
                    </tr>';
