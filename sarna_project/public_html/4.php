                    ...
                    <div class="col-md-4">
                        <div class="single_product pb-2">
                            ...
                            <div class="product_content">
                                <h3><a href="product.php">Coolers -Sizes and description</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="single_product pb-2">
                            ...
                            <div class="product_content">
                                <h3><a href="product.php">Mist Fans- Sizes and description</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="single_product pb-2">
                            ...
                            <div class="product_content">
                                <h3><a href="product.php"> Heaters- Sizes and description</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="single_product pb-2">
                            ...
                            <div class="product_content">
                                <h3><a href="product.php">Bazooka heater- Sizes and description</a></h3>
                            </div>
                        </div>
                    </div>
