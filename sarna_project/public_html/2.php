                    ...
                    <div class="col-md-4">
                        <div class="single_product pb-2">
                            ...
                            <div class="product_content">
                                <h3><a href="product.php">Trolley</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="single_product pb-2">
                            ...
                            <div class="product_content">
                                <h3><a href="product.php">Bhatties / Cooking Ranges</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="single_product pb-2">
                            ...
                            <div class="product_content">
                                <h3><a href="product.php">  Tables- work table, service table, Dish landing table</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="single_product pb-2">
                            ...
                            <div class="product_content">
                                <h3><a href="product.php">Counter-Service counter- Pick up counter</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="single_product pb-2">
                            ...
                            <div class="product_content">
                                <h3><a href="product.php">Bar be Que- Sizes and description</a></h3>
                            </div>
                        </div>
                    </div>
